...
contract AdvancedWhitelistToken is SimpleRestrictedToken {
  address public senderWhitelist;
  address public receiverWhitelist;

  constructor () {
    senderWhitelist = Whitelist.deploy();
    receiverWhitelist = Whitelist.deploy();
  }
}
